...
*/
    ...
    /**
     * Query the USGS dataset and return a list of {@link EarthCustomClass} objects.
     */
    public static List<EarthCustomClass> fetchEarthQuakeData(String requestURL)
    {
        Log.v(LOG_TAG," fetctEarthQuakeData");
        ...
        List<EarthCustomClass> earthquakes = extractFeaturesFromJSON(jsonResponse);
        // Return the list of {@link EarthCustomClass}s
        return earthquakes;
    }
    /**
    ...
    /**
     * Return a list of {@link EarthCustomClass} objects that has been built up from
    ...
    public static String makeHTTPRequest(URL url) throws IOException
    {
        ...
        {
            Log.e(LOG_TAG,"Problem retrieving the  earthquake Json result and Check your internet Connection",e);
     ...
     * InputStream class representing an input stream of bytes.
    ...
    private static String readFromStream(InputStream inputStream) throws IOException
    {
        ...
        if(inputStream!=null)
        {
            /* InputStreamReader class is a bridge from byte streams to character streams.
    ...
    public static List<EarthCustomClass> extractFeaturesFromJSON(String earthquakeJSON) {
        ...
        List<EarthCustomClass> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            {
                JSONObject currentEarth=eartharray.getJSONObject(i);
                ...
                EarthCustomClass data=new EarthCustomClass(magitude,location,date,url);
                // Add the new {@link EarthCustomClass} to the list of earthquakes.
                earthquakes.add(data);//earthquakes is variable of ArrayList<EarthCustomClass>
            }
