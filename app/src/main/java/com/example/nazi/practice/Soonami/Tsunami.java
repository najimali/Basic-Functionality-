package com.example.nazi.practice.Soonami;
...
public class Tsunami extends AppCompatActivity {
    ...
    public static final String LOG_TAG = Tsunami.class.getSimpleName();
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                urlConnection.setRequestMethod("GET");//GET is a http method, used to retrieve data from the servers.
                urlConnection.setReadTimeout(10000 /* milliseconds */);
                urlConnection.setConnectTimeout(15000 /* milliseconds */);
                urlConnection.connect();
                //If request was successfull (respond code 200)
                //the read from inputStream and parse the jsonResponse
